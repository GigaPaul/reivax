...
const MUSIC_OUTPUT = $("#musicOutput")[0];
const AMBIENCE_OUTPUT = $("#ambienceOutput")[0];
...
function GeneratePlaylists() {
    ...
    MUSIC_OUTPUT.appendChild(categoryContainer);
    ...
    let music = new Playlist(this, categoryContainer);
...
class Adventure {
    ...
    LoadPlaylists() {
        $(this.playlists).each(GeneratePlaylists);
    }
...
class Playlist {
    ...
    play(music)
    {
        this.index = this.songs.indexOf(music);
        this.playedSongs.push(music);
